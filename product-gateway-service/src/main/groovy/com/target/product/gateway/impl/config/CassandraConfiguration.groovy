package com.target.product.gateway.impl.config
...
import com.target.product.gateway.impl.config.cassandra.CassandraTemplate
import com.target.product.gateway.impl.config.cassandra.CassandraManager
